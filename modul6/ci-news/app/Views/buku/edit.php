...
<body>
            ...
            <div class="col-12 col-md-6">
                <form action="<?= base_url('/buku/' . $buku['id'] . '/edit') ?>" method="post">
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <a href="<?= base_url('/buku') ?>" class="btn btn-info">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr"></script>
</body>
