...
function tampilmember()
{
    ...
    if(!empty($result)){
        foreach ($result as $member) {
            ...
            echo "<td>"."<a href = 'formmember.php?id_member=".$member['id_member']."'>Edit Member</a><br></br>";
...
function tampilpeminjaman()
{
    ...
    if(!empty($result)){
        foreach ($result as $peminjaman) {
            ...
            echo "<td>"."<a href = 'formpeminjaman.php?id_peminjaman=".$peminjaman['id_peminjaman']."'>Edit Data Peminjaman</a><br></br>";
